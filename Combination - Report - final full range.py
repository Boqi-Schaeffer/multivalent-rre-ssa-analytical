...
"""PLOTTING"""
f, axs = plt.subplots(2, 2, sharey='col')
...
if 'break_iter 1' in folder_name2:
    axs[1,0].title.set_text(r"Selectivity comparison low $N_R$ range, time-weighted average")
    axs[1,1].title.set_text(r"Bound fraction comparison low $N_R$ range, time-weighted average")
else:
